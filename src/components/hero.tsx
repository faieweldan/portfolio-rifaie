    ...
    <section className="flex min-h-screen items-center justify-center px-6">
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="relative h-28 w-28 overflow-hidden rounded-full shadow-lg shadow-black/10 ring-2 ring-border dark:shadow-black/30">
            <Image
              src="/profile.svg"
              alt="Profile photo"
              fill
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: false, margin: "-80px" }}
          className="mb-3 text-sm tracking-wide text-accent"
        >
          Hello, I&apos;m
        </motion.p>
